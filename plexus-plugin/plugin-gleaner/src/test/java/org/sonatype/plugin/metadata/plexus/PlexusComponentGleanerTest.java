...
import org.sonatype.plugin.test.InjectMapOfUserCustomComponents;
    ...
    extends PlexusTestCase
{
    ...
    public void test_injectMap()
        throws Exception
    {
        String[] componentClassNames = {
            DefaultUserCustomComponent.class.getName(),
            NamedUserCustomComponent.class.getName(),
            InjectMapOfUserCustomComponents.class.getName()
        };
        ...
        InjectMapOfUserCustomComponents component =
            (InjectMapOfUserCustomComponents) this.lookup( ManagedInterface.class );
                         ...
                         final List<UserCustomComponent> injectedViaRequirement )
    {
        ...
        assertEquals( "Inject via @Inject different then via @Requirement",
                      injectedViaRequirement.size(),
                      injectedViaInject.size()
        );
    }

    private void verify( final Map<String, UserCustomComponent> injectedViaInject,
                         final Map<String, UserCustomComponent> injectedViaRequirement )
    {
        assertNotNull( injectedViaInject );
