...
public final class RequestUtil
{
     ...
     */
    public static final SimpleDateFormat DATE_FORMAT_RFC1123 = new SimpleDateFormat( "EEE, dd MMM yyyy HH:mm:ss zzz" );

    public static final SimpleDateFormat DATE_FORMAT_RFC1036 = new SimpleDateFormat( "EEEE, dd-MMM-yy HH:mm:ss zzz" );

    public static final SimpleDateFormat DATE_FORMAT_ANSI_C = new SimpleDateFormat( "EEE MMM d HH:mm:ss yyyy" );

    static
    {
        DATE_FORMAT_RFC1123.setTimeZone( TimeZone.getTimeZone( "GMT" ) );

        DATE_FORMAT_RFC1036.setTimeZone( TimeZone.getTimeZone( "GMT" ) );

        DATE_FORMAT_ANSI_C.setTimeZone( TimeZone.getTimeZone( "GMT" ) );
    }

    /**
     * For formatting we use last RFC format.
     * 
     * @param date
     * @return
     */
    ...
    {
        return DATE_FORMAT_RFC1123.format( date );
    }

    /**
     * For parsing we try all known in order as they should be used.
     * 
     * @param string
     * @return
     */
    public static Date parseHttpDate( String string )
    {
        try
        {
            return DATE_FORMAT_RFC1123.parse( string );
        }
        catch ( ParseException e1 )
        {
            try
            {
                return DATE_FORMAT_RFC1036.parse( string );
            }
            catch ( ParseException e2 )
            {
                try
                {
                    return DATE_FORMAT_ANSI_C.parse( string );
                }
                catch ( ParseException e3 )
                {
                    throw new IllegalArgumentException( "Cannot parse string " + string + " as HTTP Date!" );
                }
            }
     ...
     * This method is useful only for normalizing application-generated paths. It does not try to perform security
