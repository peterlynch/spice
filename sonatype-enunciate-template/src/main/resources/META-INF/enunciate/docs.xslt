...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" exclude-result-prefixes="#default" xmlns:redirect="http://xml.apache.org/xalan/redirect" extension-element-prefixes="redirect">
  ...
  <xsl:variable name="global-sidnav">
    <div>
      <div class="content">
        <h3>Home</h3>
        <ul class="menu">
          <li><a href="{$index-page-name}" title="Introduction">Introduction</a></li>
          <xsl:if test="$downloads-exists">
            <li>
              <a href="downloads.html">Libraries</a>
            </li>
          </xsl:if>
        </ul>
      </div>
        ...
        <div class="content">
          ...
          <ul class="menu">
            <xsl:for-each select="/api-docs/rest/resources/resource">
              ...
              <li><a href="rest{translate(@name,$rest_translate_chars,$rest_translate_replacements)}.html" title="{@name}"><xsl:value-of select="@name"/></a></li>
            </xsl:for-each>
          </ul>
        </div>
      </div>
                ...
                <xsl:choose>
                  <xsl:when test="tag[@name='deprecated']">
                    <font style="text-decoration:line-through;">
                      <a href="soap_{../@namespaceId}_{@name}.html" title="{@name}"><xsl:value-of select="@name"/></a>
                    </font>
                  </xsl:when>
                  <xsl:otherwise>
                    <a href="soap_{../@namespaceId}_{@name}.html" title="{@name}"><xsl:value-of select="@name"/></a>
            ...
            <xsl:for-each select="/api-docs/data/schema/elements/element">
              ...
              <li>
                <xsl:choose>
                  <xsl:when test="tag[@name='deprecated']">
                    <font style="text-decoration:line-through;">
                      <a href="data_{../../@namespaceId}.html#element_{@name}" title="{@name}"><xsl:value-of select="@name"/><xsl:if test="$multiple_schemas"> (<xsl:value-of select="../../@namespaceId"/>)</xsl:if></a>
                    </font>
                  </xsl:when>
                  <xsl:otherwise>
                    <a href="data_{../../@namespaceId}.html#element_{@name}" title="{@name}"><xsl:value-of select="@name"/><xsl:if test="$multiple_schemas"> (<xsl:value-of select="../../@namespaceId"/>)</xsl:if></a>
            ...
            <xsl:for-each select="/api-docs/data/schema/types/type">
              ...
              <li>
                <xsl:choose>
                  <xsl:when test="tag[@name='deprecated']">
                    <font style="text-decoration:line-through;">
                      <a href="data_{../../@namespaceId}.html#{@name}" title="{@name}"><xsl:value-of select="@name"/><xsl:if test="$multiple_schemas"> (<xsl:value-of select="../../@namespaceId"/>)</xsl:if></a>
                    </font>
                  </xsl:when>
                  <xsl:otherwise>
                    <a href="data_{../../@namespaceId}.html#{@name}" title="{@name}"><xsl:value-of select="@name"/><xsl:if test="$multiple_schemas"> (<xsl:value-of select="../../@namespaceId"/>)</xsl:if></a>
        ...
        <div class="content">
          ...
          <ul class="menu">
            <xsl:for-each select="/api-docs/data/jsonSchema/type">
              ...
              <li><a href="data_{../@schemaId}.html#{@name}" title="{@name}"><xsl:value-of select="@name"/><xsl:if test="$multiple_schemas"> (<xsl:value-of select="../@schemaId"/>)</xsl:if></a></li>
            </xsl:for-each>
          </ul>
        </div>
      </div>
  ...
  <xsl:variable name="footer">
    <div id="footer">
      <div id="block-menu-secondary-links">
        <div class="content">
          <ul class="menu">
            <li class="leaf first active-trail"><a href="http://sonatype.com/about" title="About Sonatype" class="active">About</a></li>
            <li class="leaf"><a href="http://sonatype.com/about/privacy" title="Sonatype Privacy Policy">Privacy Policy</a></li>
            <li class="leaf last"><a href="http://sonatype.com/about/terms" title="Sonatype Terms of Use">Terms of Service</a></li>
          </ul>
        </div>
      </div>
      <div>
        <div class="content">
          <p style="margin-right: 20px; margin-left: 20px; font-size: 80%;">Copyright <xsl:text disable-output-escaping="yes">&#38;</xsl:text>#169; Sonatype Inc. All rights reserved. Includes the third-party
            code listed at <a href="http://www.sonatype.com/products/nexus/attributions">http://www.sonatype.com/products/nexus/attributions</a>.
            Sonatype and Sonatype Nexus are trademarks of Sonatype, Inc. Apache
            Maven is a trademark of the Apache Foundation. M2Eclipse is a trademark
            of the Eclipse Foundation. All other trademarks are the property of
            their respective owners.</p>
          <p style="margin-right: 20px; margin-left: 20px; font-size: 80%;">Documentation generated by <a href="http://enunciate.codehaus.org">Enunciate</a>.</p>
        </div>
      </div>
    </div>
  </xsl:variable>
  ...
  <xsl:template match="/">
    <html>
      ...
      <body class="not-front sidebar-right">
        <div id="page">
          <div id="header">
            <div id="logo-title">
              <a href="http://sonatype.com/" title="Home" rel="home" id="logo"><img src="images/sonatype_logo.gif" alt="Home"/></a>
            </div>
            <!-- /logo-title -->
            ...
            <div id="navigation">
              <div id="primary">
                <ul class="links primary-links">
                  <li><a href="http://sonatype.com/products" title="Products">PRODUCTS &amp; SERVICES</a></li>
                  <li><a href="http://sonatype.com/about" title="About Sonatype">ABOUT</a></li>
                  <li><a href="http://blogs.sonatype.com/" title="Sonatype Blogs">BLOGS</a></li>
                  <li><a href="http://store.sonatype.com/" title="Buy Sonatype products">STORE</a></li>
                  <li><a href="http://www.sonatype.com/contact" title="Contact Sonatype">CONTACT</a></li>
                </ul>
              </div>
            </div>
            <!-- /navigation -->
            ...
            <div id="header-region">
              <h1 class="title"><xsl:value-of select="/api-docs/@title"/></h1>
            </div>
                    ...
                    <div>
                      <div>
                        <div class="content">
                          ...
                          <xsl:if test="not(/api-docs/documentation)">
                            <!--Include an introduction if there is top-level documentation.-->
                            <h1>Welcome</h1>
                          </xsl:if>
                            ...
                            <xsl:for-each select="method">
                              ...
                              <li>
                                <xsl:choose>
                                  <xsl:when test="tag[@name='deprecated']">
                                    <font style="text-decoration:line-through;">
                                      <a href="#{@name}" title="{@name}"><xsl:value-of select="@name"/></a>
                                    </font>
                                  </xsl:when>
                                  <xsl:otherwise>
                                    <a href="#{@name}" title="{@name}"><xsl:value-of select="@name"/></a>
